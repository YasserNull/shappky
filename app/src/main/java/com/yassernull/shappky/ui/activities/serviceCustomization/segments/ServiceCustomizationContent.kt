...
fun ServiceCustomizationContent(
  ...
  Scaffold(
    ...
    Column(
      ...
      com.yassernull.shappky.ui.activities.serviceCustomization.sections.ServiceCustomizationSelectAppsSection(
      ...
      com.yassernull.shappky.ui.activities.serviceCustomization.sections.ServiceCustomizationRun(
        serviceDuration = serviceDuration,
        onServiceDurationChange = { serviceDuration = it },
      )

      com.yassernull.shappky.ui.activities.serviceCustomization.sections.ServiceCustomizationKillWhenReachRam(
      ...
      com.yassernull.shappky.ui.activities.serviceCustomization.sections.ServiceCustomizationEnableTriggers(
        enableRules = enableRules,
        onEnableRulesChange = { enableRules = it },
      )

      com.yassernull.shappky.ui.activities.serviceCustomization.sections.ServiceCustomizationDisableTriggers(
