...
import com.yn.shappky.services.ShappkyWidgetService
...
class ShappkyListWidgetProvider : AppWidgetProvider() {
  ...
  companion object {
    const val ACTION_APP_CLICK = "com.yn.shappky.ACTION_APP_CLICK"
    const val ACTION_REFRESH = "com.yn.shappky.ACTION_REFRESH"
