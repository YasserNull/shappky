package com.yn.shappky.providers
...
class ShappkyWidgetProvider : AppWidgetProvider() {
  ...
  override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
    ...
    for (appWidgetId in appWidgetIds) {
      if (prefs.contains(WidgetPreferences.getTriggerIdKey(appWidgetId))) {
        ...
        val configIntent = Intent(context, com.yn.shappky.ui.activities.widgetConfig.WidgetConfigActivity::class.java).apply {
  ...
  companion object {
    const val ACTION_WIDGET_CLICK = "com.yn.shappky.ACTION_WIDGET_CLICK"
