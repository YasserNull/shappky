...
import com.yn.shappky.core.preferences.KEY_FULL_SCREEN
...
fun applyWidgetThemeFromPreferences(activity: Activity) {
  ...
  val themeId = if (dynamic) {
    when (theme) {
      "white" -> com.yn.shappky.R.style.Theme_WidgetConfig_Dynamic_Light
      "black" -> com.yn.shappky.R.style.Theme_WidgetConfig_Dynamic_Black
      else -> com.yn.shappky.R.style.Theme_WidgetConfig_Dynamic_Dark
    }
  } else {
    when (theme) {
      "white" -> com.yn.shappky.R.style.Theme_WidgetConfig_Light
      "black" -> com.yn.shappky.R.style.Theme_WidgetConfig_Black
      else -> com.yn.shappky.R.style.Theme_WidgetConfig_Dark
    }
  }
...
fun applyWidgetDynamicColorsFromPreferences(activity: Activity) {
  ...
  if (prefs.getBoolean("dynamicColors", false)) {
    ...
    if (prefs.getString("appTheme", "dark") == "black") {
      activity.theme.applyStyle(com.yn.shappky.R.style.AppTheme_Dynamic_Black_Override, true)
    }
  }
}
