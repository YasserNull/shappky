...
object MainActions {
  fun onOpenSettings(context: android.content.Context) {
    context.startActivity(android.content.Intent(context, com.yn.shappky.ui.activities.settings.SettingsActivity::class.java))
  }
  ...
  fun onOpenTriggers(context: android.content.Context) {
    context.startActivity(android.content.Intent(context, com.yn.shappky.ui.activities.triggers.TriggersActivity::class.java))
  }
